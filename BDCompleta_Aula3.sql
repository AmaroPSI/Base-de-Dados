...
CREATE TABLE produtos (
  ...
  marca varchar(50),
  cod_barras decimal(13,0) UNIQUE,
  obs varchar(500),
...
INSERT INTO categorias_produtos VALUES (1,'DVD','Utilizada não só para filmes, mas também software'),
(2,'Computadores','Portáteis, PCs Desktop, Notebooks, etc.'),
(3,'Telemóveis','Telemóveis e smartphones'),
(4,'SmartGadgets','Smartwatches, Google glasses, pulseiras medidoras, etc.'),
(5,'Eletrodomésticos',NULL),
(6,'Ação',NULL),
(7,'Brinquedos','Para crianças'),
(8,'Periféricos Info','Ratos, teclados, monitores');

INSERT INTO produtos (nome,marca,cod_barras,preco,id_categoria) VALUES ('Telemóvel NEFFOS','TP-LINK', 6900000001234,69.99,3);
INSERT INTO produtos (nome,marca,cod_barras,preco,id_categoria) VALUES ('Macbook Pro 15'' MLH42','Apple', 7600000009876,3659,2);
INSERT INTO produtos (nome,marca,cod_barras,preco,obs,id_categoria) VALUES ('Smartwatch Gear S3 classic', 'Samsung', 7600000005555,219.85,'Por encomenda',4);
INSERT INTO produtos (nome,marca,cod_barras,obs,preco,id_categoria) VALUES ('Smartwatch Gear S2 Preto','SAMSUNG',7600000007777,'Descontinuado',200.99,4),('Depiladora AS5546','Asus',6900084754600,NULL,199.99,5),('Descascadora de batatas AS6600','Asus',6900084754700,'Must have',999.50,5),('DVD Rambo-A Fúria do Herói',NULL,5602872663765,'Obra prima do cinema',69.99,1),('DVD Star Wars-O Despertar da força',NULL,560785,NULL,14.99,1),('Action Camera ALTOS TRALHOS Hero 5','SAMSUNG',6900004657432,'Best Seller',687.00,6);
